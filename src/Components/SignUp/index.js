...
import { Paper, TextField, Grid, Button, Typography, Radio, RadioGroup, FormControlLabel } from '@material-ui/core';
import './signup.css'

class RegForm extends Component {
    state = { data:null,mail:false,names:false,surname:false,pass:false,confirm:false,value:'Member' }
    ...
    render() { 
        return ( 
            <React.Fragment >
                ...
                <Grid item xs={6} style={{marginBottom:"1.6vw"}}>
                <Paper style={this.styles.paper} >
                   ...
                   <FormControlLabel value="Member" control={<Radio />} label="Member" />
                    ...
                    <Grid item>
                        <Button onClick={this.sgnclick} variant="contained" color="primary" style={{marginTop:"1vw"}} >
                            Register
                        </Button>
                    </Grid>
                    </Grid>
